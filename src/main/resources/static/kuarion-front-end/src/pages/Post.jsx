...
function Post() {
  ...
  const fetchPosts = async () => {
    try {
      const res = await axios.get(`http://http://srv802017.hstgr.cloud/forum/communities/${communityId}/posts`);
  ...
  const createPost = async () => {
    ...
    try {
      ...
      await axios.post(`http://http://srv802017.hstgr.cloud/forum/communities/${communityId}/posts`, {
        title,
        content,
        author,
      });
