...
@JsonIgnore
  private EnterpriseSurveyAnswers enterpriseSurveyAnswers;
  
  

  public EnterpriseSurveyAnswers getEnterpriseSurveyAnswers() {
	return enterpriseSurveyAnswers;
}

public void setEnterpriseSurveyAnswers(EnterpriseSurveyAnswers enterpriseSurveyAnswers) {
	this.enterpriseSurveyAnswers = enterpriseSurveyAnswers;
}
